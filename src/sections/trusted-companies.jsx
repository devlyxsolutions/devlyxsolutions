    ...
    return (
        <section className="flex flex-col items-center">
            <SectionTitle 
                ...
                description="Our web development expertise is trusted by UK businesses for modern, fast, and reliable digital solutions." 
            />
            ...
            >
                ...
                <div className="flex flex-col items-center md:items-start max-md:text-center">
                    <a href="#trial" className="group flex items-center gap-2 rounded-full text-sm p-1 pr-3 text-indigo-300 bg-indigo-200/15">
                    ...
                    <p className="text-base text-slate-400 max-w-lg mt-4">
                        Devlyx builds modern, responsive websites and applications — fully optimized for performance and seamless user experience.
                    </p>
                ...
                <div className="md:-mr-16 max-md:mt-10">
                    <img className="max-w-xs md:max-w-sm rounded-xl shadow-lg" src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/trusted-brand/image-fc6e.png" alt="Trusted Companies" />
                </div>
            </motion.div>
        </section>
    );
