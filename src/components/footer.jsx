        ...
        >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                ...
                <div className="sm:col-span-2 lg:col-span-1">
                    <a href="https://devlyx.com">
                        <img className="h-9 w-auto" src="/assets/wlgo.png" width={138} height={36} alt="Devlyx logo" />
                    </a>
                    <p className="text-sm/7 mt-6">
                        Devlyx is a UK-based web development company delivering fast, modern, and responsive websites and applications with precision and creativity.
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        ...
                        <a className="hover:text-slate-500 transition" href="#">About Devlyx</a>
                ...
                <div>
                    ...
                    <div className="text-sm space-y-6 max-w-sm">
                        <p>Get the latest Devlyx updates, web development tips, and insights straight to your inbox weekly.</p>
            ...
            <p className="py-4 text-center border-t mt-6 border-slate-700">
                Copyright 2026 © <a href="https://devlyx.com">Devlyx</a> All Rights Reserved.
            </p>
        </motion.footer>
    );
};
